...
import { CreateLessonPronounceDto } from 'src/dto/create-lesson-pronounce.dto';

@Controller('lesson-pronounce')
@UseGuards(JwtAuthGuard) // đăng nhập mới cho sử dụng controler
export class LessonPronounceController {
  private readonly logger = new Logger(LessonPronounceController.name);
  constructor(private readonly TService: LessonPronounceService) {}
  ...
  @Post()
  create(@Body() createDto: CreateLessonPronounceDto) {
