...
import { CreateLessonQuestionFinalDto } from 'src/dto/create-lesson-question-final.dto';

@Controller('lesson-question-final')
@UseGuards(JwtAuthGuard) // đăng nhập mới cho sử dụng controler
export class LessonQuestionFinalController {
  private readonly logger = new Logger(LessonQuestionFinalController.name);
  constructor(private readonly TService: LessonQuestionFinalService) {}
  ...
  @Post()
  create(@Body() createDto: CreateLessonQuestionFinalDto) {
