...
import { CreateLessonsDto } from 'src/dto/create-lessons.dto';
...
export class LessonsController {
  ...
  constructor(private readonly TService: LessonsService) {}
  ...
  @Get(':courseId/getId')
  async getLessonId(@Param('courseId') id: string) {
    return await this.TService.findId(id);
  }
  ...
  @Post()
  create(@Body() createDto: CreateLessonsDto) {
